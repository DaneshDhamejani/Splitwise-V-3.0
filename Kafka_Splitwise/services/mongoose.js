...
mongoose.connect('mongodb+srv://danesh123:danesh123@splitwisecluster.qrygt.mongodb.net/myFirstDatabase?retryWrites=true&w=majority',{poolSize: 10}).then( () => { console.log("Mongoose is Connected") },
